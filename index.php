...
if(isset($_POST['button_process'])) { 
  //START OF PROSES TRANING NAIVE BAYES------------------------------------------------------------
    ...
    $judul_skripsi_baru = $_POST['judul_skripsi_baru'];
    $judulBaru = "";
    if(strlen($judul_skripsi_baru)>0){
      $judulBaru = $judul_skripsi_baru;
      ...
      if($iMAX>-1){
          ...
          $calon_pembimbing = $hasilKlasifikasi;
      }
...
}//end of if isset post button_process
?>
            ...
            <div class="col-12 mx-auto">
              <div class="mt-n8 mt-md-n9 text-center">
                <img
                  ...
                  src="assets/img/unsulbar_logo.jpg"
                  alt="bruce"
                  loading="lazy"
                />
              </div>
              <div class="row py-5">
                ...
                >
                  ...
                  >
                    <h3 class="mb-0">
                      Naive Bayes Text Classifier untuk Penentuan Pembimbing
                      Skripsi
                    </h3>
                  </div>
                  <div class="row mb-4">
                  ...
                  <p class="text-lg mb-0">
                    Abstract: If you can’t decide, the answer is no. If two
            ...
            <div class="col-12 mx-auto">
              <form class="p-3" id="contact-form" method="post">
                <div class="card-header px-4 py-sm-5 py-3">
                  <h2>PROSES</h2>
                  <p class="lead">Training dan Testing Naive Bayes</p>
                </div>
                    ...
                    <div class="col-md-12 pe-2 mb-3">
                      <div class="input-group input-group-static mb-4">
                        ...
                        <input
                          type="text"
                          class="form-control"
                          placeholder="<?=$judul_skripsi_baru; ?>"
                          name="judul_skripsi_baru"
                        />
                      </div>
                    </div>
                    <div class="col-md-12 pe-2 mb-3">
      ...
      <div class="container z-index-1 position-relative">
        <div class="row">
          <div class="col-lg-4 me-auto mb-lg-0 mb-4 text-lg-start text-center">
            <h6
              class="text-dark font-weight-bolder text-uppercase mb-lg-4 mb-3"
            >
              Material Design
            </h6>
            <ul
